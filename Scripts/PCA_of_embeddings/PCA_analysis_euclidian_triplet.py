...
#logging information
logging.basicConfig(filename='PCA_euclidian_triplet.log', filemode='w', format='%(asctime)s - %(message)s', datefmt='%d-%b-%y %H:%M:%S', level=logging.INFO)
...
plt.show()
plt.savefig('pca_queries_and_corpus_euclidian_triplet.png')

joblib.dump(pca, 'pca_model_euclidian_triplet.pkl') 