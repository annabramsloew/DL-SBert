...
In this script, we evaluate our Triplet model trained with cosine similarity. This script has been adapted for 
our project as well.
"""
...
#logging information
logging.basicConfig(filename='Cos_Triplet_Eval_IR.log', filemode='w', format='%(asctime)s - %(message)s', datefmt='%d-%b-%y %H:%M:%S', level=logging.INFO)
...
logging.info(f"length is {str(len(corpus.keys()))}")
# Evaluate the model
