...
#logging information
logging.basicConfig(filename='Euclid_Triplet_Eval_IR.log', filemode='w', format='%(asctime)s - %(message)s', datefmt='%d-%b-%y %H:%M:%S', level=logging.INFO)


logging.info("Loading model")
# Specify the path to the model
print(os.getcwd())
model_path = "/zhome/d2/a/175738/ML_BERT/DL-SBert/Scripts/triplet_euclid"
