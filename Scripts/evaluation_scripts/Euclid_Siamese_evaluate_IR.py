...
In this script, we evaluate our Siamese model trained with euclidean distance. This script has been adapted for 
our project as well.
"""
import logging
import requests
...
from sentence_transformer_dtu.evaluation.InformationRetrievalEvaluator import InformationRetrievalEvaluator
import numpy as np


#logging information
logging.basicConfig(filename='Euclid_Siamese_Eval_IR.log', filemode='w', format='%(asctime)s - %(message)s', datefmt='%d-%b-%y %H:%M:%S', level=logging.INFO)


logging.info("Loading model")
# Specify the path to the model
print(os.getcwd())
model_path = "/zhome/d2/a/175738/ML_BERT/DL-SBert/Scripts/siamese_euclidian"
